...
<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <!-- Our Team Section --->
        <a href="our_team_section.php" class="sl-menu-link active">
          <div class="sl-menu-item">
  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
      ...
      <div class="card pd-20 pd-sm-40 mg-t-50">
          ...
          <button class="btn btn-primary" data-target="#addModal" data-toggle="modal" style="max-width: 100px;margin-bottom: 10px;">Add Member</button>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="action.php?teamID=<?= $data['id'] ?>" class="btn"><i class="fa fa-trash" aria-hidden="true" style="font-size: 30px;color: red;"></i></a>
                    </td>
                  </tr>
                <?php
                  }
        ...
        <div class="modal-dialog" style="width: 800px;">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title">Edit Memeber Info</h4>
           ...
           <form action="action.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body" >
              ...
              <div class="form-group">
                ...
                <input type="text" id="title" class="form-control" autocomplete="off" placeholder="Enter title" name="title" required>
              </div> 
              ...
              <div class="form-group">
                <label for="image">Image: (Choose Image to change)</label>
                <input type="file" id="image" class="form-control" placeholder="Enter image" name="img_file">
              </div> 
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary" name="btn-memberedit">Submit</button>
          ...
          <div class="modal-content">
           ...
           <form action="action.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body" >
              ...
              <div class="form-group">
                <label for="image">Image: (Choose Image to upload)</label>
                <input type="file" id="image" class="form-control" placeholder="Enter image" name="img_addfile" required>
              </div> 
              ...
              <!-- Modal footer -->
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary" name="btn-memberadd">Submit</button>
              <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
            </div>
           </form>
          </div>
