    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column active">
          <li class="nav-item"><a href="header_section_textLOGO.php" class="nav-link active">Text Logo</a></li>
...
<!-- ########## END: LEFT PANEL ########## -->
  ...
  <div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <span class="breadcrumb-item active">Text LOGO</span>
    </nav>

    <div class="sl-pagebody"><!-- MAIN CONTENT -->
      <div class="sl-page-title">
          <h5>Text Logo</h5>
          <p>Update Brand Name of your Website.</p>
      </div><!-- sl-page-title -->

      <div class="card pd-20 pd-sm-40">
         <form action="action.php" method="POST">
          <input type="text" name="text_logo" class="form-control wd-250" placeholder="Input" value="<?= $header_section['text_logo'] ?>">
          
          <button type="submit" name="btn-textLogo" class="btn btn-success mt-2" style="max-width: 150px;">Update</button>
