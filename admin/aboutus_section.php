...
<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <!-- About Us Section --->
        <a href="aboutus_section.php" class="sl-menu-link active">
          <div class="sl-menu-item">
...
<!-- ########## END: LEFT PANEL ########## -->
  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
      ...
      <div class="sl-page-title">
          <h5>About Us</h5>
          <p>Update About Us of your Website.</p>
      </div><!-- card -->
        ...
        <div class="col-xl-6">
          <form action="action.php" method="POST">
            <div class="card pd-20 pd-sm-40">
              ...
              <textarea id="aboutus_section_textarea" class="form-control" rows="5" cols="10" name="description" style="height: 500px;"><?= $aboutus_section['description'] ?></textarea>
              
              <span style="color: red;font-weight: 700;"><?php if (isset($_GET['msg'])) {
                echo $_GET['msg'];
              } ?></span>
              <button type="submit" class="btn btn-success mt-2" name="btn-aboutus" style="max-width: 100px;">Update</button>
            </div>
      ...
      <!-- Image part -->
        <div class="col-xl-6 mg-t-25 mg-xl-t-0">
          <div class="card pd-20 pd-sm-40" style="background-color: #F4F0F0;">
               
            <h5>Image</h5>
            <form action="action.php" method="POST" enctype="multipart/form-data">

              <img src="<?= "../".$aboutus_section['image'] ?>" style="max-width: 70%;">
              
              <div class="input_section mt-3">
                <input type="file" name="about_us_file" required style="border: 2px solid black;">
                
                <span style="color: red;font-weight: 700;"><?php if (isset($_GET['aboutmsg'])) {
                    echo $_GET['aboutmsg'];
                  } ?>
                </span>
                
                <input type="submit" name="btn-aboutus_img" class="btn btn-primary">  
              </div>
  ...
  <script>
        ...
        // tinymce.init({selector:'#aboutus_section_textarea'});
