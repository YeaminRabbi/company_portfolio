<?php
  ...
  if (empty($_GET['textID'])) {
    header("Location: section_contact_us.php");
  }
...
<?php
  ...
  $textdata=fetch_data_byID($db,"contact_us", $textID);

  update_data_byID($db,"contact_us","read_status","1",$textID);
  ...
  function fetch_data_byID($db,$table_name,$id)
  {
  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
     ...
     <div class="sl-page-title">
      ...
      <a href="section_contact_us.php" class="btn btn-primary mb-3">BACK PREVIOUS</a>
      ...
      <div class="row row-sm">
        <div class="col-xl-6">
            ...
            <div class="card pd-20 pd-sm-40">
              ...
              <h5>TEXT</h5>
              <textarea style="font-size: 20px;height: 300px;"><?= $textdata['text'] ?></textarea>
          ...
          <div class="col-xl-6 mg-t-25 mg-xl-t-0">
              ...
              <div class="card pd-20 pd-sm-40">
                 ...
                 <h5>Sender</h5>
                 <div class="mt-3">
                   <p style="font-size: 20px;">Name: <span style="font-weight: 700;"><?= $textdata['name'] ?></span></p>
                   <p style="font-size: 20px;">Email: <span style="font-weight: 700;"><?= $textdata['email'] ?></span></p>
                   <p style="font-size: 20px;">Contact: <span style="font-weight: 700;"><?= $textdata['contact'] ?></span></p>
                 </div>
