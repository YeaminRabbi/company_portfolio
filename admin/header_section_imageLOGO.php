    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column active">
          ...
          <li class="nav-item"><a href="header_section_imageLOGO.php" class="nav-link active">Image Logo</a></li>
  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
      ...
      <div class="sl-page-title">
          <h5>Image Logo</h5>
          <p>Update Brand Image of your Website.</p>
      </div><!-- sl-page-title -->

      <div class="content p-3 d-flex flex-wrap justify-content-around" style="background-color: #EAEAEA;">
         <div class="update-form ml-0">
           <form action="action.php" method="POST" enctype="multipart/form-data">
            
            <input type="file" name="img_file" class="form-control mt-3">
            ...
            <br>
            <button type="submit" name="btn-imageLogo" class="btn btn-success mt-3" style="max-width: 150px;">Update</button>
           </form> 
         </div>

         <div class="view-current-image m-2">
            <h3>Current Logo</h3>
