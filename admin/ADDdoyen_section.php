...
<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="ADDdoyen_section.php" class="nav-link active">Add Doyen</a></li>
  ...
  <div class="sl-mainpanel">
    ...
    <div class="sl-pagebody"><!-- MAIN CONTENT -->
      ...
      <div class="sl-page-title">
          <h5>Doyens</h5>
          <p>Update Doyens Sections of your Website.</p>
     ...
     <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Doyen Informations</h6>
            ...
            <div class="row mg-b-25">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="name" autocomplete="off" placeholder="Enter Name" required>
                    </div>
                  </div><!-- col-4 -->
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="title" autocomplete="off" placeholder="Enter Title" required>
                    </div>
                  </div><!-- col-4 -->
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="file" name="img_doyenfile" required class="file" accept="image/*">
                    </div>
                  </div><!-- col-4 -->
                  ...
                  <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                      ...
                      <div class="ml-2 col-sm-6">
                        <img src="" alt="img" id="preview" class="img-thumbnail" style="width: 300px;">
                    </div>
                  </div><!-- col-4 -->
                </div><!-- row -->

                <div class="form-layout-footer ml-3">
                  <button class="btn btn-info mg-r-5" type="submit" name="btn-addDeyon">Submit Form</button>
